...
class HtmlInjector {
    ...
    getInjectData() {
        return {
            ...
            OG_SITE_NAME: this.config?.og?.siteName || 'hispace',
            ...
            OG_IMAGE: this.config?.og?.image || 'https://p2p.hispace.com/images/preview.png',
            OG_URL: this.config?.og?.url || 'https://p2p.hispace.com',
