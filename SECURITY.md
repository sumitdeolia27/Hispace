...
- Product version ([GitHub](https://github.com/miroslavpejic85/hispace/commits/master) commit hash or [DockerHub](https://hub.docker.com/r/hispace/p2p) sha256 digest hash)
