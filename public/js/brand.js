...
let brand = {
    app: {
        language: 'en',
        name: 'hispace',
        title: 'hispace<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
...
function handleWidget() {
    if (brand.widget?.enabled) {
        ...
        if (typeof hispaceWidget !== 'undefined') {
            new hispaceWidget(domain, roomId, userName, brand.widget);
        } else {
            console.warn('hispaceWidget is not defined. Please check widget.js loading.', {
                domain,
                roomId,
                userName,
                widget: brand.widget,
