...
If you would like to deploy hispace to kubernetes
...
This is generic ingress object in kubernetes that is responsible to route external traffic to hispace deployed application and if used in conjuction with p2p-cert.yaml (default) will provide TLS enabled access to your hispace instance
