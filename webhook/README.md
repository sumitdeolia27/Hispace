...
This example shows how to set up a server to listen for hispace P2P webhook events (join, disconnect).
...
hispace P2P sends HTTP `POST` requests to the specified URL with event data:
